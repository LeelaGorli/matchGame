...
class App extends Component {
  ...
  render() {
    const {userscore, seconds, activeTabId, matchImg, isGameFinish} = this.state
    ...
    return (
      <div className="app-container">
        ...
        <div className="main-container">
          {isGameFinish ? (
            <ScoreCard scoreDetails={userscore} playAgain={this.playAgain} />
          ) : (
            <ul>
              <img src={matchImg} alt="match" className="main-image" />
              ...
              <ul className="project-list-container">
                {filteredProjects.map(eachprojectDetails => (
                  <ProjectItem
                    key={eachprojectDetails.id}
                    projectDetails={eachprojectDetails}
